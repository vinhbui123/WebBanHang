...
namespace WebBanHang.Areas.admin.Controllers
{
    ...
    public class AdminProductDetailsController : Controller
	{
		...
		public AdminProductDetailsController(WebBanHangContext context)
		{
			_context = context;
		}
		...
		{
			var WebBanHangContext = _context.ProductDetails.Include(p => p.Product);
		...
		public async Task<IActionResult> Create(ProductDetail productDetail, IFormFile fImage1)
		{
