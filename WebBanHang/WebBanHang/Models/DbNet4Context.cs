...
public partial class DbNet4Context : DbContext
{
    public DbNet4Context()
    {
    }

    public DbNet4Context(DbContextOptions<DbNet4Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-SJRDH053\\MSSQLSERVER03;Database=dbNet4;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Customer>(entity =>
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__8CB382B1B7E2DD84");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__F1FF84539D3B612E");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.OrderId }).HasName("PK__Order_it__B72C07D728101B4C");
        ...
        {
            entity.HasKey(e => e.PaymentMethodId).HasName("PK__PaymentM__7BB18931D1E31EC0");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__9833FF92A3F59CF6");
            ...
            entity.HasMany(d => d.Promotions).WithMany(p => p.Products)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ProductId", "PromotionId").HasName("PK__Promotio__B59CD77B6E139679");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product___9833FF92926D037D");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__DAF28E9313215010");
        ...
        {
            entity.HasKey(e => e.ShipId).HasName("PK__Ship__58D18D039CE748C2");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Stocks__9833FF924F31B9AD");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__Stores__A0F06719F3495809");
