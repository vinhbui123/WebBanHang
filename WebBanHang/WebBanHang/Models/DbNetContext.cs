...
public partial class DbNetContext : DbContext
{
    ...
    public DbNetContext(DbContextOptions<DbNetContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-SJRDH053\\MSSQLSERVER03;Database=dbNet;Integrated Security=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Accounts__B19D41816BE37D5F");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__Customer__8CB382B1949A5DB5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__F1FF845328D5D12C");
        ...
        {
            entity.HasKey(e => new { e.ProductId, e.OrderId }).HasName("PK__Order_it__B72C07D7D473B355");
        ...
        {
            entity.HasKey(e => e.PaymentMethodId).HasName("PK__PaymentM__7BB18931179E9DEC");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__9833FF92D4584F7E");
            ...
            entity.HasMany(d => d.Promotions).WithMany(p => p.Products)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("ProductId", "PromotionId").HasName("PK__Promotio__B59CD77B72DB2808");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__Promotio__DAF28E93CE276236");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__D80BB0932301FBAB");
        ...
        {
            entity.HasKey(e => e.ShipId).HasName("PK__Ship__58D18D03940D6636");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Stocks__9833FF9240031CF5");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__Stores__A0F0671981C634FF");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__Type_Pro__FE91E1E68D43387F");
