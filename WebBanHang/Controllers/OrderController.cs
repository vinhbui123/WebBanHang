...
namespace WebBanHang.Controllers
{
	public class OrderController : Controller
	{
		...
		public IActionResult CreateOrder(OrderVm orderVm, string paymentMethod)
		{
			...
			// Create a list to hold all OrderItem instances
			...
			_db.AddRange(orderItems);  // Add all items at once
			_db.SaveChanges();  // Save changes once after adding all items
			}

			// Add all OrderItems to the database in one go
